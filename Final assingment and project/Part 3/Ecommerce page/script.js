...
const productImageSmall = document.querySelectorAll(".product-image-small");
...
tabBox.addEventListener("click", function (e) {
  ...
  //   remove active class
   productImageSmall.forEach((element) => element.classList.remove("active-small")); //remove rectangular border line after clicked another product-image-small
  productImage.forEach((element) => element.classList.remove("active"));
